...
impl Default for GimbalModeResponse {
    fn default() -> Self {
        Self {
            gimbal_mode: GimbalMode::default(),
        }
    }
}
#[derive(Debug, Clone, Copy, PartialEq)]
...
impl Message {
    pub const fn cmd_id(&self) -> u8 {
        match self {
            ...
            Self::MaxZoomRangeRequest(_) => MaxZoomRangeRequest::CMD_ID,
            Self::MaxZoomRangeResponse(_) => MaxZoomRangeResponse::CMD_ID,
            ...
            Self::CurrentZoomRequest(_) => CurrentZoomRequest::CMD_ID,
            Self::CurrentZoomResponse(_) => CurrentZoomResponse::CMD_ID,
            Self::GimbalModeRequest(_) => GimbalModeRequest::CMD_ID,
            Self::GimbalModeResponse(_) => GimbalModeResponse::CMD_ID,
            ...
            Self::MagneticEncoderAngleRequest(_) => MagneticEncoderAngleRequest::CMD_ID,
            Self::MagneticEncoderAngleResponse(_) => MagneticEncoderAngleResponse::CMD_ID,
    ...
    pub const fn is_request(&self) -> bool {
        match self {
            ...
            Self::MaxZoomRangeRequest(_) => MaxZoomRangeRequest::IS_REQUEST,
            Self::MaxZoomRangeResponse(_) => MaxZoomRangeResponse::IS_REQUEST,
            ...
            Self::CurrentZoomRequest(_) => CurrentZoomRequest::IS_REQUEST,
            Self::CurrentZoomResponse(_) => CurrentZoomResponse::IS_REQUEST,
            Self::GimbalModeRequest(_) => GimbalModeRequest::IS_REQUEST,
            Self::GimbalModeResponse(_) => GimbalModeResponse::IS_REQUEST,
            ...
            Self::MagneticEncoderAngleRequest(_) => MagneticEncoderAngleRequest::IS_REQUEST,
            Self::MagneticEncoderAngleResponse(_) => MagneticEncoderAngleResponse::IS_REQUEST,
    ...
    pub fn encode(&self, buf: &mut [u8]) -> Result<usize, EncodeError> {
        match self {
            ...
            Self::MaxZoomRangeRequest(m) => m.encode(buf),
            Self::MaxZoomRangeResponse(m) => m.encode(buf),
            Self::LaserTargetLocationRequest(m) => m.encode(buf),
            Self::LaserTargetLocationResponse(m) => m.encode(buf),
            Self::CurrentZoomRequest(m) => m.encode(buf),
            Self::CurrentZoomResponse(m) => m.encode(buf),
            Self::GimbalModeRequest(m) => m.encode(buf),
            Self::GimbalModeResponse(m) => m.encode(buf),
            ...
            Self::MagneticEncoderAngleRequest(m) => m.encode(buf),
            Self::MagneticEncoderAngleResponse(m) => m.encode(buf),
    ...
    pub fn from_frame(frame: &Frame) -> Result<Self, DecodeError> {
        ...
        match frame.cmd {
            ...
            0x16 => {
                if frame.ctrl.is_response() {
                    Ok(Self::MaxZoomRangeResponse(MaxZoomRangeResponse::decode(
                        data,
                    )?))
                } else {
                    Ok(Self::MaxZoomRangeRequest(MaxZoomRangeRequest::decode(
                        data,
                    )?))
                }
            }
            ...
            0x18 => {
                if frame.ctrl.is_response() {
                    Ok(Self::CurrentZoomResponse(CurrentZoomResponse::decode(
                        data,
                    )?))
                } else {
                    Ok(Self::CurrentZoomRequest(CurrentZoomRequest::decode(data)?))
                }
            }
            0x19 => {
                if frame.ctrl.is_response() {
                    Ok(Self::GimbalModeResponse(GimbalModeResponse::decode(data)?))
                } else {
                    Ok(Self::GimbalModeRequest(GimbalModeRequest::decode(data)?))
                }
            }
            0x20 => {
                if frame.ctrl.is_response() {
            ...
            0x26 => {
                if frame.ctrl.is_response() {
                    Ok(Self::MagneticEncoderAngleResponse(
                        MagneticEncoderAngleResponse::decode(data)?,
                    ))
                } else {
                    Ok(Self::MagneticEncoderAngleRequest(
...
///
/// This module contains message definitions for the **ZR10** camera
...
/// - [`GimbalModeRequest`] (0x19): Request current gimbal mode
/// - [`GimbalModeResponse`] (0x19): Gimbal mode
/// - [`MagneticEncoderAngleRequest`] (0x26): Request magnetic encoder angles
/// - [`MagneticEncoderAngleResponse`] (0x26): Magnetic encoder angles
...
/// - [`MaxZoomRangeRequest`] (0x16): Request max zoom range
/// - [`MaxZoomRangeResponse`] (0x16): Max zoom range
/// - [`CurrentZoomRequest`] (0x18): Request current zoom level
/// - [`CurrentZoomResponse`] (0x18): Current zoom
///
/// ### Laser Ranging
///
